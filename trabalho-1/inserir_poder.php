...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto p-6 max-w-2xl">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Cadastrar Novo Poder</h1>
        <form action="inserir_poder.php" class="space-y-4" method="POST">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Poder: </label>
                <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" name="poder" required>
            </div>
            <div>

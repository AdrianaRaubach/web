...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-3xl font-bold text-gray-800 mb-6">Lista de Tipos</h1>
            
            <div class="overflow-x-auto">
                <table class="min-w-full table-auto">
                    <thead class="bg-gray-200">
                        <tr>
                            <th class="px-4 py-3 text-left">Nome do Tipo</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 flex gap-2">
                                <form action='remover/remover_tipo.php' method='POST' class="inline">
                                ...
                                <form action='editar/editar_tipo.php' method='POST' class="inline">
